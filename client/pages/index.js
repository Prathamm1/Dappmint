...
const style = {
  wrapper: `flex justify-center h-screen w-screen select-none bg-[#15202b] text-white sm:flex-col md:flex-row`,
  content: ` max-w-[1400px] w-full flex justify-between`,
  loginContainer: `w-full h-full flex flex-col justify-center items-center pb-12 sm:pb-24 md:pb-48`,
  walletConnectButton: `text-xl md:text-2xl text-black bg-white font-bold mb-[-3rem] mt-[3rem] px-4 md:px-6 py-2 md:py-4 rounded-full cursor-pointer hover:bg-[#d7dbdc]`,
